...
% page foot
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize add1.3-en - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
...
\section*{ANOVA}
	Decompose the total sum of squared in sum of squared residuals and sum of squared explained:
	$\SST = \SSR + \SSE$
	\begin{center}
		\scalebox{0.86}{
...
\section*{Logistic regression}
	...
	\end{center}
	where $P_i = \E(y_i = 1 | x_i)$ and $(1 - P_i) = \E(y_i = 0 | x_i)$ \\
