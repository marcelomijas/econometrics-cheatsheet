...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize ADD-24.6-EN - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
...
\begin{document}
	\begin{multicols}{3}
		...
		Under no heterocedasticity and no auto-correlation, the variance-covariance matrix:
		...
		Under \textcolor{cyan}{\textbf{heterocedasticity}} and \textcolor{magenta}{\textbf{auto-correlation}}, the variance-covariance matrix:
