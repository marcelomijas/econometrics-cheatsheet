...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize ts1.8-es - github.com/marcelomijas/econometrics-cheatsheet - Licencia CC-BY-4.0}}
	...
	\subsection*{Supuestos MCO bajo series temporales}
		...
		\begin{enumerate}[leftmargin=*, label=st\arabic*.]
			...
			\begin{enumerate}[leftmargin=*, label=\alph*.]
				...
				\item No hay variables relevantes no incluidas en el modelo: $\Cov(x_j , u) = 0 \quad \forall j = 1, ..., k \rightarrow$ \textbf{exogeneidad débil}.
			\end{enumerate}
			\item \textbf{Homocedasticidad}. La variabilidad de los resid. es igual para cualquier nivel de $x$: $\Var(u | x_1, ..., x_k) = \sigma^2_u$
...
\section*{Heterocedasticidad en series temp.}
	...
	\subsection*{ARCH}
		...
		Dado el modelo: $y_t = \beta_0 + \beta_1 z_t + u_t$
