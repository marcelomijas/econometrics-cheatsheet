...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize ts1.5-es - github.com/marcelomijas/econometrics-cheatsheet - CC BY 4.0}}
	...
	\subsection*{Corrección}
		\begin{itemize}[leftmargin=*]
			...
			\begin{itemize}[leftmargin=*]
				...
				\item Si $\rho$ es \textbf{desconocido}, estimarlo -por ejemplo- el \textbf{método de Cochrane-Orcutt} (el método de Prais-Winsten también es bueno):
