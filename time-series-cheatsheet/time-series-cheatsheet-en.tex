...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize ts2.1-en - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
...
\begin{enumerate}[leftmargin=*, label=t\arabic*.]
	...
	\item \textbf{Normality}. Residuals are independent and identically distributed (\textbf{i.i.d.} so on): $u \sim N(0, \sigma^2_u)$
...
\begin{itemize}[leftmargin=*]
	...
	\item Hold t1 to t5: \textbf{asymptotic normality} of OLS (then, t6 is necessarily satisfied): $u \underset{a}{\sim} N(0, \sigma^2_u)$
