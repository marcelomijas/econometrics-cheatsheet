...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize TS-25.01-EN - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
...
\begin{document}
	\begin{multicols}{3}
		...
		\begin{itemize}[leftmargin=*]
			...
			\begin{multicols}{2}
				\item \textbf{Correlogram} - composed of the autocorrelation function (ACF) and the partial ACF (PACF).
