...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize TS-24.7.1-EN - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
...
\begin{document}
	\begin{multicols}{3}
		...
		For example: $\lbrace x_{t} \rbrace$ and $\lbrace y_{t} \rbrace$ are I(1), but $y_{t} - \beta x_{t} = u_{t}$ where $\lbrace u_{t} \rbrace$ is I(0). ($\beta$ get the name of cointegration parameter).
		...
		Some tests that work could be the Breusch-Pagan or White's, where $H_{0}$: No heterocedasticity. It is \textbf{important} for the tests to work that there is \textbf{no auto-correlation} (so first, it is imperative to test for it).
