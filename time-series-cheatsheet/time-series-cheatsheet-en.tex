...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize ts1.8-en - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
...
\section*{Assumptions and properties}
	\subsection*{OLS model assumptions under time series}
		...
		\begin{enumerate}[leftmargin=*, label=ts\arabic*.]
			...
			\end{enumerate}
			\item \textbf{Homoscedasticity}. The variability of the residuals is the same for any $x$: $\Var(u | x_1, ..., x_k) = \sigma^2_u$
...
\section*{Heterocedasticity on time series}
	...
	\subsection*{ARCH}
		...
		Given the model: $y_t = \beta_0 + \beta_1 z_t + u_t$
