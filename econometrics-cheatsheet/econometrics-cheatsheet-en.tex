...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize 3.3-en - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
...
\begin{enumerate}[leftmargin=*]
	...
	\item \textbf{Normality}. Residuals are independent and identically distributed: $u \sim N(0, \sigma^2_u)$
...
\begin{itemize}[leftmargin=*]
	...
	\item Hold 1 to 5: \textbf{asymptotic normality} of OLS (then, 7 is necessarily satisfied): $u \underset{a}{\sim} N(0, \sigma^2_u)$
