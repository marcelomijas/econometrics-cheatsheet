...
% page foot
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize 3.1-en - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
	...
	\subsection*{Econometric model assumptions}
		...
		\begin{enumerate}[leftmargin=*]
			...
			\begin{enumerate}[leftmargin=*, label=\alph*.]
				...
				\item There are no relevant variables left out of the model: $\Cov(x_j , u) = 0 \quad \forall j = 1, ..., k \rightarrow$ \textbf{weak exogeneity}.
			\end{enumerate}
			\item \textbf{Homoscedasticity}. The variability of the residuals is the same for all levels of $x$: $\Var(u | x_1, ..., x_k) = \sigma^2_u$
			\item \textbf{No auto-correlation}. Residuals do not contain information about any other residuals: $\Corr(u_t, u_s | x_1, ..., x_k) = 0 \quad \forall t \neq s$. (Typical of time series)
...
\section*{Hypothesis testing}
	...
	\subsection*{Individual tests}
		...
		\end{center}
		If $\mid t \mid > \mid t_{n-k-1, \alpha/2} \mid$, there is evidence to reject $H_0$. \\
