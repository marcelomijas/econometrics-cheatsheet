...
% page foot
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize Version 2.8-en - github.com/marcelomijas/econometrics-cheatsheet - CC BY 4.0}}
...
\section*{Ordinary Least Squares}
	...
	\subsection*{Error measures}
		...
		\\ Square Root of the Quadratic Mean Error: \hfill $\sqrt{\frac{\sum_{i=1}^n (\hat{u}_i - \overline{u})^2}{n}}$
