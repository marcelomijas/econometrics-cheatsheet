...
% ----- pdf metadata -----
\hypersetup{
	pdftitle={Hoja de Referencia Econometría},
...
\cfoot{\href{https://github.com/marcelomijas/econometrics-cheatsheet}{\normalfont \footnotesize CS-25.08-ES - github.com/marcelomijas/econometrics-cheatsheet - CC-BY-4.0 license}}
...
Estudiar y predecir el valor medio de una variable (dependiente, \( y \)) respecto a unos valores fijos de otras variables (variables independientes, \( x \)). En econometría es común usar Mínimos Cuadrados Ordinarios (MCO) para análisis de regresión.
...
\begin{center}
	\scalebox{0.85}{
		\begin{tabular}{ c c c c }
			Modelo      & Dependiente   & Independ.       & Interpretación \( \beta_{1} \)                         \\ \hline
