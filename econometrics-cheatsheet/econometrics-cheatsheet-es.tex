...
\begin{itemize}[leftmargin=*]
	\item \textbf{$\sum_{i=1}^n \hat{u}^2$} - es la $\SSR$ del modelo no restringido: $\SSR_\mathrm{UR}$
	\item \textbf{$\sum_{i=1}^n \hat{u}_\mathrm{r}^2$} - es la $\SSR$ del modelo restringido: $\SSR_\mathrm{R}$.
\end{itemize}
